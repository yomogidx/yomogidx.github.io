...
export class Game {
    ...
    private distance: number;     // 距離
    private socre: number;        // スコア
    private textScore: PIXI.Text; // スコア表示

    private chara: FieldObject;   // つちのこ
    private balloon: FieldObject; // 風船
    private objects: Array<FieldObject>; //障害物
    private stage: Array<FieldObject>; // ステージオブジェクト
    private line: PIXI.Graphics;  // 風船とつちのこの線
    ...
    constructor(app: PIXI.Application<HTMLCanvasElement>) {
        ...
        this.stage = new Array<FieldObject>();
